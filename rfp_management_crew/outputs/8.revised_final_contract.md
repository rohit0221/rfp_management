...
|--------------------------|----------------|---------------|----------------|---------------------|
| Cloud Storage            | 99.99%          | 15 minutes    | 2 hours        | 10% service credit  |
...
- **Regulatory Compliance:** Supplier must adhere to **GDPR, SOC2, ISO 27001, HIPAA, PCI-DSS, FedRAMP** (as applicable).  
- **Data Security:**  
